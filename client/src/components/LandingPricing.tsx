    ...
    <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
      ...
      >
        ...
        <button 
          ...
          className="w-full h-11 mt-auto bg-[#555a63] hover:bg-[#454a52] text-white rounded-xl text-[14px] font-bold transition-colors duration-200"
        >
          Get Started
        </button>
      </motion.div>
      ...
      >
        ...
        <button 
          onClick={() => navigate("/register")}
          className="w-full h-11 mt-auto bg-[var(--accent)] hover:bg-[#0c5945] text-white rounded-xl text-[14px] font-bold transition-colors duration-200"
        >
          Subscribe to Plus
        </button>
      </motion.div>
      ...
      >
        ...
        <button 
          onClick={() => navigate("/register")}
          className="w-full h-11 mt-auto bg-[var(--primary)] hover:bg-[#1a233a] text-white rounded-xl text-[14px] font-bold transition-colors duration-200"
        >
          Subscribe to Pro
        </button>
      </motion.div>
